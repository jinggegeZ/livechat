  ...
  <div class="content">
    <div class="content-c">
      <div class="loginbox">
        ...
        <div class="input">
          <div class="inputbox">
            <el-input v-model="username" placeholder="请输入用户名" @blur="username(e)"></el-input>
          </div>
        </div>
        <!-- 选择头像 -->
        ...
        <div class="imgbox">
          <div class="imgbox1" >
            <div class="imgbox1-1" v-for="(item,index) in imgs" :key="index" @click="chose(item,index)" :class="{'change':active === index}">
...
export default {
  ...
  methods: {
    ...
    //去聊天页
    gohome(){
      this.$socket.emit('login', this.username,this.avatar);   
      // this.$router.push('/')
    }
  },
  mounted() {

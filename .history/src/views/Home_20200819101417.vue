        ...
        <div class="box2">
          ...
          <div class="box2-2">
            <div class="box2-2-1">
              ...
              <div class="file"><input  type="file" placeholder="和朋友开聊！！！！" /></div>
              <div>
            ...
            <div class="box2-2-2">
              <input  type="file" placeholder="和朋友开聊！！！！" />
              <div class="pickerbox" v-if="flag === true"><picker @select="addEmoji" set="emojione" /></div>
            </div>
            <div class="box2-2-3">
